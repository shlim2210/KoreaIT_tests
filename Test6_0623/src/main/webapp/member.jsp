...
<body>
    ...
    <form action="member_ok.jsp" method="post" name="regform" id="regform" onsubmit="return sendit()">
        ...
        <p>취미 : <label>드라이브<input type="checkbox" name="hobby" value="드라이브"></label> <label>등산<input type="checkbox" name="hobby" value="등산"></label> <label>게임<input type="checkbox" name="hobby" value="게임"></label> <label>운동<input type="checkbox" name="hobby" value="운동"></label> <label>영화감상<input type="checkbox" name="hobby" value="영화감상"></label></p>
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6"> - <input type="text" name="ssn2" id="ssn2" maxlength="7"> <input type="button" value="검증" id="ssnBtn"></p>
        <p>우편번호 : <input type="text" name="zipcode" id="sample6_postcode" maxlength="5" readonly> <input type="button" value="우편번호 검색" onclick="sample6_execDaumPostcode()"></p>
